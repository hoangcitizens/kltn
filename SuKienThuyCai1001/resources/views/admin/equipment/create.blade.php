...
@section('title', 'Thêm thiết bị mới')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Thêm thiết bị mới</h1>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('quantity') is-invalid @enderror" 
                                   id="quantity" name="quantity" value="{{ old('quantity') }}" required min="1">
                            @error('quantity')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
...
<script>
    $(document).ready(function() {
        // Khởi tạo Select2 cho danh mục và loại thiết bị
        $('.select2').select2({
            theme: 'bootstrap-5',
            width: '100%',
